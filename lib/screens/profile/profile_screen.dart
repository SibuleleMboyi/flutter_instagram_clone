...
import 'package:flutter_instagram/screens/comments/comments_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    super.initState();
    // when adding more Tabs, change the 'length' parameter to match the number of tabs.
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ProfileBloc, ProfileState>(
      ...
      builder: (context, state) {
        return Scaffold(
          appBar: AppBar(
            title: Center(child: Text(state.user.username)),
            actions:[
              if(state.isCurrentUser)
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    context.read<LikedPostsCubit>().clearAllLiPosts();
                  },
                ),
