...
class CreatePostScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(title: Center(child: const Text('Create Post')),),
                        ...
                        child: Column(
                          ...
                          children: [
                            TextFormField(
                              ...
                              onChanged: (caption) => context.read<CreatePostCubit>().captionChanged(caption),
                              validator: (caption) => caption.trim().isEmpty
                            ...
                            RaisedButton(
                              ...
                              onPressed: () => _submitForm(context, state.postImage ,state.status == CreatePostStatus.submitting),
