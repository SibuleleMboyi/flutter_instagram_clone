...
class SignupScreen extends StatelessWidget {
  ...
  static Route route(){
    return MaterialPageRoute(
      ...
      /// Because Signup Cubit won't be accessed out side Signup Screen,
      /// we therefore provide it exactly where it's needed and used, here.
  ...
  Widget build(BuildContext context) {
    return  WillPopScope(
      onWillPop: () async => false,  /// Prevents a user from sliding back to the previous screen
  ...
  void _submitForm(BuildContext context, bool isSubmitting){
    if(_formKey.currentState.validate() && !isSubmitting){  /// isSubmitting means the user has signup in progress
